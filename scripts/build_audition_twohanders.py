...
SCENES = {
    ...
    key("F", "SD"): {
        ...
        "lines": [
            ...
            ("FATHER", "You will not allow me to be anything more than that one afternoon. A whole life of mine, and you nail me to half an hour of it and call it the truth."),
            ("STEP-DAUGHTER", "That half-hour was my whole life, in that room. I was two months an orphan, and you were a 'kind gentleman' who happened to be my mother's husband, and you did not recognise me. That is your defence — and it is the very worst thing about you."),
            ("FATHER", "I did not know who you were. If I had known, do you imagine for one moment —"),
            ("STEP-DAUGHTER", "You knew I was young enough to be sold by the half-hour. You knew that much, and it did not stop you, and it would not have stopped you, if my mother had not come through that door and seen us both."),
    ...
    key("M", "MG"): {
        ...
        "lines": [
            ...
            ("MOTHER", "You want it plainly. There is no plainly. There is a husband who sent me away, a man I was given to who died, a daughter sold in a back room, a little one drowned in a fountain, a boy with a revolver. Tell me — where, in all of that, is the plain sentence you can stage?"),
    ...
    key("SD", "MG"): {
        ...
        "lines": [
            ...
            ("STEP-DAUGHTER", "Why must they bear it so lightly? I had to bear it whole — a girl of eighteen, two months an orphan, in a back room with my own stepfather's hands. Let them sit with that for two hours. It is a good deal less time than I have had to sit with it."),
    ...
    key("SD", "P3"): {
        ...
        "lines": [
            ("MADAME PACE", "Cara! You come back to me. I knew you come back — the young ones, they always come back to Madame Pace, sooner or later, one way or another way. It is the one thing in life you can put in the book ahead of time."),
            ...
            ("MADAME PACE", "Eh — remember, come back, for the book it is all the same thing, cara. You owe. Your mother, she owe — the silk she ruin with her poor bad sewing, somebody must pay for it. The book, you understand, it must always, always balance."),
            ...
            ("MADAME PACE", "I smile because I am a polite woman, and I count because that is my trade and I am good at it. The polite ones, cara, the ones who keep the count — we are the ones who are still here at the end. Your mother, she only weep. And weeping, you will find, pays nobody anything."),
            ...
            ("MADAME PACE", "I sell what is asked for, no more, no less. If you must be angry, cara, be angry at the one who asked — he had the good coat, the soft quiet voice, the money already folded in the pocket. Me, I only opened the door for him. That is all I ever do. I open the door."),
    ...
    key("M", "P3"): {
        ...
        "lines": [
            ...
            ("MOTHER", "You sold my child. While I sat sewing in your back room for a few miserable francs, you were in the front room selling my own child."),
            ("MADAME PACE", "I sold a dress, madame, a room, a half-hour of somebody's quiet afternoon. What happens between two people behind the folding screen — that, you understand, is not written anywhere on my book."),
