...
PARTS = [
    ...
    ("Act One — The Family", "Part III", "Part III of Act One", '<div class="part-eyebrow">Part IV of Act One</div>'),
    ("Act One — The Family", "Part IV", "Part IV of Act One", '<div class="part-eyebrow">Part V of Act One</div>'),
    ("Act One — The Family", "Part V", "Part V of Act One", '<div class="part-eyebrow">Part VI of Act One</div>'),
    ("Act One — The Family", "Part VI", "Part VI of Act One", '<div class="curtain">— End of Act I —</div>'),
