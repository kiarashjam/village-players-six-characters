...
<main>
  ...
  <section class="act">
    ...
    <p>She and the Step-Daughter play the scene of the atelier the way it happened: the silk debt, the dress, the hundred francs, the entrance of the polite gentleman in the good coat, the Mother walking through the door. The audience watches it. Then, because the Manager has promised to stage it, the company's own Leading Lady and Leading Man climb onto the upper platform and play the same scene over again as <em>theatre</em>, with the bundle and the chair-and-coat watching from below. The Step-Daughter, on the lower floor now, laughs at the working actors trying to be her. The laugh is the wound. The Leading Lady, who has played leads at every house in this canton, has been made a fool of by better, and she means it.</p>

    <p>The Mother is forced to watch her daughter's worst hour staged in front of her, twice. The column of light falls on her — only on her — and in it, after an act and a half of silence, she finds her voice for the first time in the play.</p>
