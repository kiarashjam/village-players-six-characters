...
<main>
  ...
  <section class="backstory">
    ...
    <p>He was a man of restless intelligence and unhappy temper; she was simple, gentle, and almost silent. He married her, as he will himself admit much later in front of strangers, for exactly that simplicity. They had one son. The Father did not trust the Mother to nurse the child — she did not, as he will put it years later, seem strong enough — and so the baby was sent away, very early, to a wet-nurse in the country: a peasant woman with rough hands and no soft words. The Son stayed there. The Mother will say much later, in front of strangers, very quietly: <em>he took my son away from me first of all.</em> That was the first of the husband's removals. There would be others.</p>

    <p>The marriage did not survive what came after. He could not bear her tenderness, or his own coldness toward it; she could not bear how clearly that coldness was directed at her. They did not separate cleanly. They erased each other slowly, across years, in small daily ways, until what was left between them was a shape without weather inside it.</p>

    <p>He kept a clerk in his service — a secretary, quiet, faithful, of a temperament close to his wife's. He watched the two of them, across months, find each other in small silent ways: a glance over a teacup, a hand near a door, the slight softening that two gentle people make in the presence of a third who is not. He told himself — afterwards, at any rate — that what he did next he did for both of them. He sent his secretary away. Then, because he could no longer bear watching his wife wander the empty rooms of his house, as he himself, much later, will put it, <em>like an animal one has taken in out of pity</em>, he sent her away too, after the secretary, to live with him in another town. The Son stayed where he had always been — in the country, then in schools far from his parents' house — and saw nothing of either of them across the whole long stretch of his childhood.</p>
    ...
    <p>Years passed. The wife and the secretary built a quiet life in the other town. They had three more children together — a daughter first, then a boy, then a small girl. They lived in modest comfort. The husband, from a distance, kept watch. He never made himself known to them. He went, more than once, to the gate of the eldest daughter's school, in the afternoon when the children came out among the trees, and once waited there with a paper parcel — a fine straw hat and a bouquet of flowers, both for the child. He gave it to her, gently, smiling, and walked away. She took it, doubtful, wondering who he might be. He never told her his name. The Mother, when the child described him at home, guessed at once and kept the child home from school for some days. When the child went back, he was there again. The wife and her new family never knew, with certainty, that he was the husband and stepfather. <em>He came, sir,</em> as the Step-Daughter will say much later, very flatly, in front of strangers, <em>to see how I was growing up.</em></p>
    ...
    <p>The Father took the Mother and her three children home with him — there was nowhere else for them to go. The Son, who had been living quietly in the empty rooms of his father's house for years, found himself sharing it with a mother he did not know, three half-siblings he had never met, and the same stepfather, whom he had decided to despise before he understood why. He withdrew into a corner of a room that was no longer anyone's, and stopped speaking. He has been keeping the same silence ever since.</p>
    ...
    <p>One afternoon, when nobody was looking, the small Child fell into the fountain. The Boy did not move. He stood at the side of the basin, his hands still in his pockets, and did nothing.</p>

    <p>The Son, hearing the splash from somewhere in the house, ran across the garden — was a single step from the water — was about to jump in — and was frozen at the threshold by the sight of the Boy's face. He stopped. He did not move. The Child was lost in the few seconds it took him to stop. Soon afterwards, the Boy was gone too.</p>
  ...
  <section class="act">
    ...
    <p>She and the Step-Daughter play the scene of the atelier the way it happened. Madame Pace recites her bookkeeping — the polite client who pays in cash, the blue envelope on the little mahogany table, the names that belong to her customers for a little while, the appointments that come like the bells of Saint-François, three times a week. The laughter from the audience curdles somewhere in the middle of the aria, and they are not able afterwards to say at which sentence it curdled.</p>
  ...
  <section class="act">
    ...
    <p>The stage lights drop, breath by breath, beneath the Son's narration, until only the fountain's pale-blue glow and the bare hanging bulb remain. The chair-and-coat is silhouetted behind the basin. For ten seconds, in that low water-light, the audience sees the Boy watching his little sister in the water.</p>
