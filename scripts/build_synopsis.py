...
<main>
  ...
  <section class="backstory">
    ...
    <p>The Son, hearing the splash from somewhere in the house, ran across the garden — was a single step from the water — was about to jump in — and was frozen at the threshold by the sight of the Boy's face. He stopped. He did not move. The Child died in the few seconds it took him to stop. Soon afterwards, the Boy used what was in his pocket.</p>
