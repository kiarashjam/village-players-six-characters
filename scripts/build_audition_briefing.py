...
<main>
  ...
  <section class="role">
    ...
    <h3>Look</h3>
    <p><strong>Late 40s to mid-50s.</strong> Pirandello: she "seems crushed and terrified as if by an intolerable weight of shame and abasement. She is dressed in modest black and wears a thick widow's veil of crêpe. When she lifts this, she reveals a wax-like face. She always keeps her eyes downcast." Costume: full mourning, with the <strong>heavy widow's veil of black crêpe</strong> — the veil is half the costume, and the actor must have lived with it long enough that she carries it the way a real widow carries hers, not the way a costumed one does. Body: small, contained, pressed in on itself. When the veil is lifted — once only, in Act One, by the Father and against her will — the face beneath is pale, set, and unmoving. She never lifts it herself, not even at the fountain.</p>

    <h3>Behaviour</h3>
    <p><strong>She is the fixed wound of the family, and the production's silent centre.</strong> The Father explains the wound, the Step-Daughter exposes it, the Son refuses it — she carries it. She is not in the argument; when the others speak we hear ideas and revenge, but when the Mother <em>moves</em>, we hear the cost. Her sorrow is active, never weak: she protects, hides, interrupts, refuses to look, then suddenly looks. The <strong>Child-bundle is her anchor</strong> — she checks it when the men argue, covers it when the shop is named, holds it lower when the Son turns away, and is the first to feel it gone before the fountain. Audition for a body that can make a room go quiet without raising its voice.</p>
  ...
  <section class="role">
    ...
    <p><strong>Early 20s — a young man or a young woman; the part fits either.</strong> (These notes use <em>they</em>; settle on the pronoun that fits whoever is cast.) The youngest in the company by a good ten years. Should read as such from the back row. First proper season at the Village Players, after a few small parts last year and a drama school in Geneva they still mention when they are nervous. <strong>The happiest person in the building</strong> — they cannot quite believe they are being paid (a little) to be in a theatre at all — and they do a bit of everything: prompts from the box, reads the small parts, helps strike the set, fetches the props nobody else will. No job is beneath them. Costume: working-rehearsal clothes, but more put-together than the others — dressed <em>carefully</em> for a first big season. Body: younger, sharper, listening. The eyes track the older two to learn what one does.</p>

    <h3>Behaviour</h3>
    <p><strong>Curious is the dominant register.</strong> Where Player 1 has opinions and Player 2 has shoulders, Player 3 has questions. Leans forward when the Six are speaking. Nods. Catches themselves nodding and tries to stop. The other two notice; they colour. They are the first to take the strangers seriously — not because they believe the Father's philosophy, but because they have never seen a rehearsal interrupted in this way and they want to know what happens. Writes everything down. <strong>Arc:</strong> enthralled in Act One, stops nodding in Act Two when the shop scene plays, and by Act Three they are the audience's mirror at every horror — the only one in the room still asking whether someone should stop it.</p>

    <h3>Tone of speaking</h3>
    <p>A young voice, clear, <strong>slightly uncertain at the end of sentences</strong> — the rising intonation of someone who has not yet decided what they think but wants you to consider it. Phrases that land: <em>"Perhaps there is a play." "Is anyone else following this?" "Should we — should someone — stop this?"</em></p>

    <h3>Coach against</h3>
    <ul>
      <li><strong>Becoming a generic ingénue.</strong> Curious, not naive. There is a difference.</li>
      <li><strong>Cuteness.</strong> Earnest. Earnestness reads as serious when it is not performed.</li>
      <li><strong>Disappearing in the second half.</strong> Few lines after Act One, but the face is the audience's mirror at every horror. Cast someone who stays alive while watching.</li>
    </ul>

    <div class="solo">
      <p class="solo-label">Three-sentence solo &nbsp;·&nbsp; read alone</p>
      <p class="solo-text">"This is my first proper season — I keep saying that, I know, but it is true, and I keep saying it because I want you to know that whatever I get wrong this morning I will write down, and learn, and not get wrong again next time. I have spent every evening for two weeks reading the Pirandello on the tram on the way home from work, and the strangest thing is that the more I read it the less it stops being strange — there is a family in it that I think I almost know, and a young woman in it who is trying so hard to be heard that I find I am sitting up straighter on the tram every time she speaks. I do not yet know whether I am an actor or a person who is currently acting, but I would very much like, if you will let me, to spend the next six months finding out — and I promise you I will not be the easiest person in the room, but I will be the most awake."</p>
    </div>

    <div class="listen">
      <p class="listen-label">What to listen for</p>
      <p>Young, clear, slightly rising at the end of clauses — the voice of someone who has not decided yet, but wants you to consider it. Resist the urge (theirs or yours) to make them a generic ingénue: they are <strong>curious</strong>, not naive. The audition value is in the last line: can the auditioner <em>promise</em> without becoming cute?</p>
    </div>
