...
<main>
  ...
  <section class="role">
    ...
    <p><strong>Early 20s.</strong> The youngest in the company by a good ten years. Should read as such from the back row. First proper season at the Village Players, after a few small parts last year and a drama school in Geneva she still mentions when she is nervous. <strong>The happiest person in the building</strong> — she cannot quite believe she is being paid (a little) to be in a theatre at all — and she does a bit of everything: prompts from the box, reads the small parts, helps strike the set, fetches the props nobody else will. No job is beneath her. Costume: working-rehearsal clothes, but more put-together than the others — she has dressed <em>carefully</em> for her first big season. Body: younger, sharper, listening. The eyes track the older two to learn what one does.</p>
