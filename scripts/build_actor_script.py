...
<section class="actor-production-note">
  ...
  <p>Player 1, Player 2, and Player 3 are the working actors of the Village Players company. In this script each is named only as <strong>Player&nbsp;1</strong>, <strong>Player&nbsp;2</strong>, or <strong>Player&nbsp;3</strong> — never by the role they are playing in the moment; the cast list overleaf shows which company roles (Leading Man, Property Man, Prompter, Door&#8209;keeper, and so on) each one carries. <strong>Madame Pace</strong> is not a Player function — she is a Character in her own right, carried by her own performer, conjured onto the stage in Act Two; her speeches are tagged simply <em>Madame Pace</em>.</p>
</section>
"""
