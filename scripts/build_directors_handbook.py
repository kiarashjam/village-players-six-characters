...
<main>
  ...
  <section>
    ...
    <p><strong>The governing rule: she carries the wound, she does not argue it.</strong> The Father explains it, the Step-Daughter exposes it, the Son refuses it — the Mother carries it. Do not make her cleverer; make her more unavoidable. Give her few words and let her body change the temperature: when she speaks (<em>He forced me to it</em>; <em>Not in front of her</em>; <em>My son —</em>), open a real silence after it, and do not let a Player's joke land on her pain — the comedy belongs to the company's attempt to stage the drama, never to her humiliation. The <strong>Child-bundle is her anchor</strong>: she checks it when the men argue, covers it when the shop is named, holds it lower when the Son turns away, and feels it gone before the fountain. The final image is hers — at the gunshot she reaches for the Child-bundle and then the Boy-chair, cannot hold both, and only then makes a sound; the Manager's closing line is the cold button after her body, not over it.</p>
