...
<main>
  ...
  <section class="page-break">
    ...
    <ul>
      ...
      <li><strong>The Step-Daughter and the bundle, Act Two.</strong> Tender, never sexual. The Step-Daughter holds the bundle, kisses it (top of the cloth, brief), sets it down, lifts it again. Her live monologue at the top of Act Two carries the rest. There is no contact with a performer.</li>
      ...
      <li><strong>The shop scene replayed by Player 1 and Player 2.</strong> Same rules, transposed. Player 1 and Player 2 go through the choreography the Father and the Step-Daughter just established, with the same six-inch limit. Player 2's hat-removal is "efficient, the gesture of a woman who has done it a hundred times in front of a mirror" — it is a costume action, not a sexualised one.</li>
