...
ROLES = [
    ...
    {"name": "Player 1", "stats_key": "Player 1",
     ...
     "cold_context": "Act One — the fading star's vanity",
     "sides_picks": [
         ("Excuse me — must I really wear a cook's cap", "Act One — the cook's-cap argument"),
         ...
         ("I only let them in. Don't blame me.", "Act One — the man who let them in"),
     ]},
    {"name": "Player 2", "stats_key": "Player 2",
     "cold_line": "A game! For heaven's sake — we are not children. We are serious actors.",
     "cold_context": "Act Two — the leading woman refusing 'the game'",
     "sides_picks": [
    ...
    {"name": "Player 3", "stats_key": "Player 3",
     ...
     "cold_context": "Act One — the youngest, curious",
     "sides_picks": [
         ("This is rank madness", "Act One — the youngest, in disbelief"),
