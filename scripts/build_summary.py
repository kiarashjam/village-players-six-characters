...
<main>
  ...
  <section class="note">
    ...
    <p><strong>Act Two.</strong> The set is built on two levels. The Step-Daughter speaks her opening monologue alone in a tight column of light, with the wrapped bundle in her arms and the chair-and-coat at her side, a pianist playing Satie's <em>Gymnopédie</em> underneath. Mid-speech, she pulls a revolver from the coat's pocket. Then the shop has to be summoned. The youngest in the company steps out of the prompter's box, walks up to the platform, enters a wig and a black silk dress and a long silver chain ending in a pair of scissors, and becomes Madame Pace. The audience laughs at her first line and regrets it by her last. The scene of the atelier is played once between them, then played again by the company's own actors, with the Mother forced to watch her daughter's worst hour staged in front of her twice. After an act and a half of silence, the Mother finds her voice for the only time in the play — <em>"It's taking place now. It happens all the time."</em> The piano dies on her cry.</p>
    <p><strong>Act Three.</strong> Almost all the light is gone. A low fountain basin sits at the centre of the stage, lit pale-blue from inside; a bare bulb hangs above the Manager's table, swinging slightly; a low cello drone underneath that the audience never quite hears. The Father argues philosophy across the act, and the Step-Daughter cuts him three times. The Son, who has not spoken in two acts, tells the room at last what he saw in the garden of his father's house — that he was a single step from the water when the Boy's face froze him, and he did not move. As he speaks, the Step-Daughter lowers the wrapped bundle into the basin; the basin's walls do the hiding. The stage lights drop until only the fountain's pale-blue glow and the silhouette of the chair-and-coat behind it remain. Ten seconds. Then full blackout. Then, out of the dark, the gunshot. The Manager walks out, saying the audience's own thought aloud before they have the chance to say it themselves.</p>
  </section>
