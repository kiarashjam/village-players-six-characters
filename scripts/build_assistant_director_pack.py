...
<main>
  ...
  <section class="at-a-glance">
    ...
    <dl>
      ...
      <dt>Cast</dt><dd>Nine live performers. Two stage objects in place of the two youngest characters (the chair-and-coat for the Boy; the wrapped bundle for the Child). No projection, no screen — the objects do the work throughout.</dd>
  ...
  <section>
    ...
    <ul>
      ...
      <li><strong>Thursday 9 July 2026 — Act Two table work.</strong> Madame Pace's work begins with her own performer. The Step-Daughter's solo monologue — live in the shower light with the bundle and the chair-and-coat — is walked through on its feet for the first time.</li>
  ...
  <section>
    ...
    <ul>
      ...
      <li><strong>Thu 27 Aug – Thu 3 Sep.</strong> Act Two: Madame Pace's aria and the doubled scene. The Step-Daughter / Mother / Father / Madame Pace / Player 1 / Player 2 / Player 3 work block. Detailed prompt-book entries on every staged beat.</li>
