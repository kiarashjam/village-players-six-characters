...
<main>
  ...
  <section class="at-a-glance">
    ...
    <dl>
      ...
      <dt>Cast</dt><dd>Eight live performers. Two stage objects in place of the two youngest characters (the chair-and-coat for the Boy; the wrapped bundle for the Child). No projection, no screen — the objects do the work throughout.</dd>
  ...
  <section>
    ...
    <ul>
      ...
      <li><strong>Thursday 9 July 2026 — Act Two table work.</strong> Player 3's transformation work begins. The Step-Daughter's solo monologue — live in the shower light with the bundle and the chair-and-coat — is walked through on its feet for the first time.</li>
