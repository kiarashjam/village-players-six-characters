...
PARTS = [
    ...
    ("Act 1 Part III", "Part III of Act One",   '<div class="part-eyebrow">Part IV of Act One</div>'),
    ("Act 1 Part IV",  "Part IV of Act One",    '<div class="part-eyebrow">Part V of Act One</div>'),
    ("Act 1 Part V",   "Part V of Act One",     '<div class="part-eyebrow">Part VI of Act One</div>'),
    ("Act 1 Part VI",  "Part VI of Act One",    '<div class="curtain">— End of Act I —</div>'),
